...
import { Activity, Building2, Cpu, Handshake, KeyRound, LogOut, ScrollText, ShieldCheck, ShieldAlert, Sparkles, UserCircle2, ChevronDown, Users } from 'lucide-react';
...
import { PlatformCrmPanel } from './PlatformCrmPanel.js';
import { AppFooter } from '../AppFooter.js';

const SECTIONS: Array<{ id: PlatformSection; name: string; desc: string; icon: React.ElementType }> = [
  { id: 'leads', name: 'CRM', desc: 'Leads e demonstracoes', icon: Handshake },
