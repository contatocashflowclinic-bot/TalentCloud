...
import { X, Video, CheckSquare } from 'lucide-react';
...
export const AgendaEventModal: React.FC<Props> = ({ mode, event, initialDate, members, onClose, onSaved }) => {
          ...
          <div className="p-5 space-y-4 text-xs overflow-y-auto">
            ...
            {type === 'meeting' && (
              <div>
                ...
                <textarea rows={3} value={agenda} onChange={(e) => setAgenda(e.target.value)} className={inputCls} placeholder="Um tópico por linha" />
